...
export const $IsCocontravariant = Symbol('[[IsCocontravariant]]');
export const $IsCofunctor = Symbol('[[IsCofunctor]]');
export const $IsComonad = Symbol('[[IsComonad]]');
export const $IsCoprofunctor = Symbol('[[IsCoprofunctor]]');
